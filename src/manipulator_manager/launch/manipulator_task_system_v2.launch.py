...
def generate_launch_description():
    ...
    declare_task_config = DeclareLaunchArgument(
        'task_config',
        default_value=os.path.join(config_dir, 'manipulator_task_manager_v2.yaml'),
        description='YAML config file for manipulator_task_manager_v2',
    )
    ...
    manipulator_task_manager_v2 = Node(
        package='manipulator_manager',
        executable='manipulator_task_manager_v2',
        name='manipulator_task_manager_v2',
        output='screen',
        emulate_tty=True,
        parameters=[
            task_config,
    ...
    return LaunchDescription([
        ...
        TimerAction(
            period=0.5,
            actions=[manipulator_task_manager_v2],
        ),
    ])
